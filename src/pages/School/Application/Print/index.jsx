...
import { fetchApplicationById } from '@/api/school';
    ...
    <div>
      <div className="row">
        {application && application ? (
          <div className="col-10 pt-0 my-3 mx-auto">
            <div className="card w-100 border-0 bg-white p-0 mt-3">
              <div className="row">
                <div className="col-3">
                  <img
                ...
                <div className="row mt-3">
                  ...
                  <div className="col-6">
                    ...
                    <p className="fw-500 font-xs d-block  mb-2">
                      Religion :{' '}
                      {application.student_religion ?? '___________________'}
                    </p>
                    <p className="fw-500 font-xs d-block  mb-2">
                      Blood Group :{' '}
                      {application.student_blood_group ?? '___________________'}
                    </p>
                  </div>
                  ...
                  <div className="col-6">
                    <p className="fw-500 font-xs d-block mb-2">
                      ...
                      {application.student_dob
                        ? moment(application.student_dob).format('DD/MM/YYYY')
                        : '___________________'}
                    </p>
                    <p className="fw-500 font-xs d-block  mb-2">
                    ...
                    <p className="fw-500 font-xs d-block  mb-2">
                      Nationality :{' '}
                      {application.student_nationality ?? '___________________'}
                    </p>
                  ...
                  <div className="col-lg-12">
                    <p className="fw-500 font-xs d-block  mb-2">
                      ...
                      {application.last_school_name ?? '___________________'}
                    </p>
                  </div>
                  {/* <div className="col-lg-12">
