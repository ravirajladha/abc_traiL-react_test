...
import { ApplicationTable } from '@/components/school/application';
...
function Application({ title }) {
  ...
  const handleWhatsappBulk = async (data) => {
    ...
    const response = await sendWhatsappBulkMessage(messageType, formData);
  ...
  return (
    <div>
      <ContentHeader
        ...
        buttons={[
          {
            link: `old-applications`,
            text: 'Old Applications',
          },
          {
            link: `black-listed-applications`,
            text: 'Black Listed Applications',
          },
        ]}
      />
      <div className="row">
