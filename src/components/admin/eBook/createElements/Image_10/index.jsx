...
const Image_10 = ({
  ...
  const imageLink =
    selectedValue === 'image_10_1'
      ? '/assets/images/ebook/10.1.png'
      : selectedValue === 'image_10_2'
      ? '/assets/images/ebook/10.2.png'
      : '/assets/images/ebook/10.3.png';
  ...
  const renderImageTypeFields = () => {
    switch (selectedValue) {
      case 'image_10_1':
        return generateInputFields('image_10_1', imageLink);
      case 'image_10_2':
        return generateInputFields('image_10_2', imageLink);
      case 'image_10_3':
        return generateInputFields('image_10_3', imageLink);
      default:
        return null;
    }
  };
