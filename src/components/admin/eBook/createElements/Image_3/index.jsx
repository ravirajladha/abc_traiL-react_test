...
const Image_3 = ({
  ...
  const imageLink =
    selectedValue === 'image_3_1'
      ? '/assets/images/ebook/3.1.png'
      : '/assets/images/ebook/3.2.png';
      ...
      {fields.map((field, index) => (
        <React.Fragment key={index}>
          ...
          {prefix === 'image_3_2' && (
            <div className="col-lg-4 mb-3">
              <div className="form-group">
                <label className="mont-font fw-600 font-xsss">{`Sub Text ${index + 1}-1(smaller)`}</label>
                <input
                  type="text"
                  className="form-control"
                  placeholder="Enter Text"
          ...
          <div
            className={
              prefix === 'image_3_2' ? 'col-lg-4 mb-3' : 'col-lg-8 mb-3'
            }
          >
            <div className="form-group">
  ...
  const renderImageTypeFields = () => {
    switch (selectedValue) {
      case 'image_3_1':
        return generateInputFields('image_3_1', imageLink);
      case 'image_3_2':
        return generateInputFields('image_3_2', imageLink);
      default:
        return null;
    }
  };
