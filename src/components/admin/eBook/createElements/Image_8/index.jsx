...
const Image_8 = ({
  ...
  const imageLink =
    selectedValue === 'image_8_1'
      ? '/assets/images/ebook/8.1.png'
      : '/assets/images/ebook/8.2.png';
  ...
  const generateInputFields = (prefix, imageLink = null) => (
    <>
      ...
      <div
        className={prefix === 'image_8_1' ? 'col-lg-4 mb-3' : 'col-lg-8 mb-3'}
      ></div>
  ...
  const renderImageTypeFields = () => {
    switch (selectedValue) {
      case 'image_8_1':
        return generateInputFields('image_8_1', imageLink);
      case 'image_8_2':
        return generateInputFields('image_8_2', imageLink);
      default:
        return null;
    }
  };
